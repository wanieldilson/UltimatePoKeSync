...
/// </para>
/// <para>
/// Grass, Surf and swarms. Fishing is out for the reason it is out of Hoenn, and Hidden Grotto
/// with it: its contents rotate on a timer nothing here can read.
/// </para>
...
public sealed class UnovaSequelEncounterCatalog : IEncounterCatalog
{
        ...
        IReadOnlyDictionary<string, StoryMilestone> at)
    {
        ...
        AddWild(result, at["legend"], "Abundant Shrine", EncounterMethod.ShakingGrass,
            W(79, "Slowpoke", 40, 55));
        AddWild(result, at["start"], "Aspertia City", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["toxic"], "Castelia City", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["toxic"], "Castelia Sewers", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(19, "Rattata", 14, 17), W(41, "Zubat", 14, 17), W(88, "Grimer", 15, 17));
        ...
        AddWild(result, at["jet"], "Celestial Tower", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(42, "Golbat", 31, 33), W(605, "Elgyem", 30, 33), W(607, "Litwick", 27, 33));
        AddWild(result, at["jet"], "Celestial Tower", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["quake"], "Chargestone Cave", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(299, "Nosepass", 27, 30), W(525, "Boldore", 25, 28), W(529, "Drilbur", 25, 31), W(595, "Joltik", 25, 31), W(597, "Ferroseed", 26, 31), W(599, "Klink", 26, 31), W(602, "Tynamo", 28, 31));
        AddWild(result, at["quake"], "Chargestone Cave", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["quake"], "Clay Tunnel", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(95, "Onix", 54, 57), W(208, "Steelix", 57, 57), W(299, "Nosepass", 55, 57), W(305, "Lairon", 55, 57), W(525, "Boldore", 54, 56), W(527, "Woobat", 54, 54), W(530, "Excadrill", 54, 57), W(632, "Durant", 54, 54));
        AddWild(result, at["quake"], "Clay Tunnel", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(550, "Basculin", 45, 60));
        AddWild(result, at["insect"], "Desert Resort", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(27, "Sandshrew", 19, 20), W(328, "Trapinch", 21, 21), W(551, "Sandile", 18, 19), W(554, "Darumaka", 18, 19), W(556, "Maractus", 19, 19), W(557, "Dwebble", 19, 21), W(559, "Scraggy", 19, 19), W(561, "Sigilyph", 19, 19));
        AddWild(result, at["insect"], "Desert Resort", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["insect"], "Desert Resort", EncounterMethod.ShakingGrass,
            W(450, "Hippowdon", 40, 55));
        AddWild(result, at["wave"], "Dragonspiral Tower", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(520, "Tranquill", 55, 66), W(521, "Unfezant", 57, 58), W(531, "Audino", 55, 58), W(583, "Vanillish", 55, 65), W(584, "Vanilluxe", 57, 58), W(586, "Sawsbuck", 55, 66), W(587, "Emolga", 56, 56), W(614, "Beartic", 57, 66), W(619, "Mienfoo", 66, 66), W(620, "Mienshao", 55, 66), W(621, "Druddigon", 56, 66), W(623, "Golurk", 55, 58));
        AddWild(result, at["wave"], "Dragonspiral Tower", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(550, "Basculin", 45, 60));
        AddWild(result, at["wave"], "Dreamyard", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(20, "Raticate", 57, 67), W(39, "Jigglypuff", 57, 65), W(40, "Wigglytuff", 59, 59), W(42, "Golbat", 57, 67), W(169, "Crobat", 59, 59), W(206, "Dunsparce", 57, 57), W(505, "Watchog", 56, 67), W(510, "Liepard", 56, 67), W(517, "Munna", 57, 66), W(518, "Musharna", 59, 59), W(531, "Audino", 56, 59));
        AddWild(result, at["wave"], "Dreamyard", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Dreamyard", EncounterMethod.ShakingGrass,
            W(97, "Hypno", 40, 55));
        AddWild(result, at["quake"], "Driftveil Drawbridge", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(580, "Ducklett", 23, 26));
        AddWild(result, at["quake"], "Driftveil Drawbridge", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["start"], "Floccesy Ranch", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(54, "Psyduck", 5, 5), W(179, "Mareep", 5, 5), W(206, "Dunsparce", 5, 5), W(298, "Azurill", 5, 5), W(447, "Riolu", 5, 7), W(504, "Patrat", 5, 5), W(506, "Lillipup", 4, 7), W(519, "Pidove", 7, 7), W(531, "Audino", 4, 7));
        ...
        AddWild(result, at["wave"], "Icirrus City", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(453, "Croagunk", 55, 56), W(536, "Palpitoad", 54, 57), W(588, "Karrablast", 57, 57), W(616, "Shelmet", 54, 54), W(618, "Stunfisk", 55, 56));
        ...
        AddWild(result, at["quake"], "Mistralton Cave", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(304, "Aron", 29, 30), W(525, "Boldore", 27, 28), W(527, "Woobat", 27, 28), W(529, "Drilbur", 27, 30), W(610, "Axew", 29, 30));
        AddWild(result, at["quake"], "Mistralton Cave", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["wave"], "Pinwheel Forest", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(183, "Marill", 45, 60), W(184, "Azumarill", 50, 60), W(550, "Basculin", 45, 60));
        AddWild(result, at["insect"], "Relic Castle", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(27, "Sandshrew", 19, 20), W(28, "Sandslash", 28, 29), W(343, "Baltoy", 27, 30), W(551, "Sandile", 18, 28), W(552, "Krokorok", 29, 30), W(562, "Yamask", 18, 30));
        AddWild(result, at["insect"], "Relic Castle", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["toxic"], "Relic Passage", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(19, "Rattata", 17, 17), W(20, "Raticate", 29, 29), W(95, "Onix", 16, 30), W(524, "Roggenrola", 16, 18), W(525, "Boldore", 27, 30), W(527, "Woobat", 16, 30), W(529, "Drilbur", 16, 30), W(532, "Timburr", 17, 18), W(533, "Gurdurr", 28, 30));
        AddWild(result, at["toxic"], "Relic Passage", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(183, "Marill", 10, 30), W(184, "Azumarill", 10, 30), W(550, "Basculin", 10, 30));
        AddWild(result, at["legend"], "Reversal Mountain", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(227, "Skarmory", 34, 38), W(325, "Spoink", 31, 31), W(326, "Grumpig", 33, 37), W(328, "Trapinch", 32, 34), W(329, "Vibrava", 38, 38), W(426, "Drifblim", 32, 37), W(451, "Skorupi", 31, 37), W(525, "Boldore", 32, 35), W(527, "Woobat", 32, 35), W(530, "Excadrill", 32, 35), W(531, "Audino", 31, 34));
        AddWild(result, at["legend"], "Reversal Mountain", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["legend"], "Reversal Mountain", EncounterMethod.ShakingGrass,
            W(332, "Cacturne", 40, 55));
        ...
        AddWild(result, at["wave"], "Route 1", EncounterMethod.ShakingGrass,
            W(83, "Farfetch’d", 40, 55));
        ...
        AddWild(result, at["legend"], "Route 11", EncounterMethod.ShakingGrass,
            W(284, "Masquerain", 40, 55));
        ...
        AddWild(result, at["legend"], "Route 12", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["legend"], "Route 12", EncounterMethod.ShakingGrass,
            W(84, "Doduo", 40, 55));
        ...
        AddWild(result, at["legend"], "Route 13", EncounterMethod.ShakingGrass,
            W(277, "Swellow", 40, 55));
        ...
        AddWild(result, at["wave"], "Route 15", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Route 15", EncounterMethod.ShakingGrass,
            W(22, "Fearow", 40, 55));
        ...
        AddWild(result, at["bolt"], "Route 16", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["bolt"], "Route 16", EncounterMethod.ShakingGrass,
            W(204, "Pineco", 40, 55));
        AddWild(result, at["wave"], "Route 17", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["wave"], "Route 18", EncounterMethod.Surf,
            W(592, "Frillish", 45, 60), W(593, "Jellicent", 50, 60), W(594, "Alomomola", 45, 60));
        AddWild(result, at["wave"], "Route 18", EncounterMethod.ShakingGrass,
            W(187, "Hoppip", 40, 55));
        AddWild(result, at["start"], "Route 19", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(504, "Patrat", 2, 4), W(509, "Purrloin", 2, 4));
        AddWild(result, at["start"], "Route 19", EncounterMethod.Surf,
            W(550, "Basculin", 5, 15));
        AddWild(result, at["wave"], "Route 2", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(39, "Jigglypuff", 57, 57), W(40, "Wigglytuff", 59, 59), W(108, "Lickitung", 58, 58), W(206, "Dunsparce", 57, 57), W(463, "Lickilicky", 59, 59), W(505, "Watchog", 56, 59), W(507, "Herdier", 56, 59), W(508, "Stoutland", 59, 59), W(510, "Liepard", 57, 58), W(531, "Audino", 56, 59));
        AddWild(result, at["wave"], "Route 2", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["start"], "Route 20", EncounterMethod.Surf,
            W(183, "Marill", 5, 15), W(184, "Azumarill", 5, 15), W(298, "Azurill", 5, 15), W(550, "Basculin", 5, 15));
        AddWild(result, at["start"], "Route 20", EncounterMethod.ShakingGrass,
            W(185, "Sudowoodo", 40, 55));
        AddWild(result, at["wave"], "Route 21", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["wave"], "Route 22", EncounterMethod.ShakingGrass,
            W(168, "Ariados", 40, 55));
        ...
        AddWild(result, at["wave"], "Route 3", EncounterMethod.ShakingGrass,
            W(313, "Volbeat", 40, 55));
        AddWild(result, at["insect"], "Route 4", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(551, "Sandile", 14, 17), W(554, "Darumaka", 14, 17), W(559, "Scraggy", 17, 17), W(568, "Trubbish", 14, 17));
        ...
        AddWild(result, at["bolt"], "Route 5", EncounterMethod.Grass,
            W(510, "Liepard", 22, 26), W(531, "Audino", 21, 24), W(568, "Trubbish", 21, 25), W(572, "Minccino", 21, 26), W(573, "Cinccino", 24, 24), W(574, "Gothita", 21, 26), W(587, "Emolga", 22, 22));
        AddWild(result, at["bolt"], "Route 5", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["bolt"], "Route 5", EncounterMethod.ShakingGrass,
            W(177, "Natu", 40, 55));
        ...
        AddWild(result, at["quake"], "Route 6", EncounterMethod.ShakingGrass,
            W(311, "Plusle", 40, 55));
        ...
        AddWild(result, at["jet"], "Route 7", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["jet"], "Route 7", EncounterMethod.ShakingGrass,
            W(162, "Furret", 40, 55));
        ...
        AddWild(result, at["wave"], "Route 8", EncounterMethod.ShakingGrass,
            W(195, "Quagsire", 40, 55));
        ...
        AddWild(result, at["wave"], "Route 9", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Route 9", EncounterMethod.ShakingGrass,
            W(317, "Swalot", 40, 55));
        AddWild(result, at["wave"], "Seaside Cave", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(55, "Golduck", 34, 40), W(86, "Seel", 35, 35), W(213, "Shuckle", 41, 41), W(525, "Boldore", 35, 42), W(527, "Woobat", 34, 41), W(530, "Excadrill", 34, 42), W(602, "Tynamo", 37, 37), W(603, "Eelektrik", 42, 42));
        AddWild(result, at["wave"], "Seaside Cave", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(86, "Seel", 25, 40), W(87, "Dewgong", 30, 40), W(592, "Frillish", 25, 40), W(593, "Jellicent", 25, 40));
        AddWild(result, at["legend"], "Strange House", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(20, "Raticate", 32, 33), W(42, "Golbat", 32, 33), W(354, "Banette", 32, 34), W(574, "Gothita", 31, 31), W(575, "Gothorita", 33, 34), W(607, "Litwick", 31, 33));
        AddWild(result, at["legend"], "Strange House", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Striaton City", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Striaton City", EncounterMethod.Surf,
            W(341, "Corphish", 45, 60), W(342, "Crawdaunt", 50, 60), W(550, "Basculin", 45, 60));
        AddWild(result, at["wave"], "Twist Mountain", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(95, "Onix", 54, 57), W(208, "Steelix", 57, 57), W(525, "Boldore", 54, 55), W(527, "Woobat", 54, 54), W(530, "Excadrill", 54, 57), W(533, "Gurdurr", 55, 55), W(614, "Beartic", 54, 56), W(615, "Cryogonal", 56, 57), W(631, "Heatmor", 55, 56), W(632, "Durant", 56, 57));
        AddWild(result, at["wave"], "Twist Mountain", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["legend"], "Undella Bay", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["legend"], "Undella Town", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        AddWild(result, at["legend"], "Undella Town", EncounterMethod.Surf,
            W(120, "Staryu", 25, 40), W(121, "Starmie", 30, 40), W(550, "Basculin", 30, 40), W(592, "Frillish", 25, 40), W(593, "Jellicent", 25, 40));
        AddWild(result, at["quake"], "Underground Ruins", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(95, "Onix", 54, 57), W(208, "Steelix", 57, 57), W(299, "Nosepass", 55, 57), W(305, "Lairon", 55, 57), W(525, "Boldore", 54, 56), W(527, "Woobat", 54, 54), W(530, "Excadrill", 54, 57), W(632, "Durant", 54, 54));
        AddWild(result, at["quake"], "Underground Ruins", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Victory Road (B2/W2)", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(95, "Onix", 41, 50), W(206, "Dunsparce", 49, 49), W(315, "Roselia", 48, 55), W(334, "Altaria", 49, 55), W(354, "Banette", 47, 50), W(407, "Roserade", 50, 50), W(520, "Tranquill", 47, 55), W(521, "Unfezant", 50, 50), W(525, "Boldore", 41, 50), W(530, "Excadrill", 41, 50), W(531, "Audino", 47, 50), W(533, "Gurdurr", 47, 55), W(538, "Throh", 48, 55), W(539, "Sawk", 50, 50), W(546, "Cottonee", 47, 55), W(547, "Whimsicott", 50, 50), W(621, "Druddigon", 47, 50), W(623, "Golurk", 48, 50), W(634, "Zweilous", 49, 50));
        AddWild(result, at["wave"], "Victory Road (B2/W2)", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(183, "Marill", 35, 60), W(184, "Azumarill", 40, 70), W(418, "Buizel", 35, 50), W(419, "Floatzel", 40, 50), W(550, "Basculin", 35, 70));
        ...
        AddWild(result, at["basic"], "Virbank City", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["basic"], "Virbank Complex", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(58, "Growlithe", 11, 14), W(81, "Magnemite", 10, 13), W(109, "Koffing", 10, 14), W(240, "Magby", 10, 13), W(504, "Patrat", 10, 14), W(519, "Pidove", 10, 13), W(531, "Audino", 10, 13));
        AddWild(result, at["basic"], "Virbank Complex", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(592, "Frillish", 5, 15), W(593, "Jellicent", 5, 15), W(594, "Alomomola", 5, 15));
        AddWild(result, at["wave"], "Wellspring Cave", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(525, "Boldore", 55, 58), W(527, "Woobat", 55, 58), W(530, "Excadrill", 55, 58));
        ...
        IReadOnlyDictionary<string, StoryMilestone> at)
    {
        ...
        AddWild(result, at["wave"], "Humilau City", EncounterMethod.Surf,
            W(120, "Staryu", 30, 45), W(121, "Starmie", 35, 45), W(222, "Corsola", 35, 45), W(550, "Basculin", 35, 45), W(592, "Frillish", 30, 45), W(593, "Jellicent", 35, 45));
        AddWild(result, at["wave"], "Icirrus City", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(453, "Croagunk", 55, 56), W(536, "Palpitoad", 54, 57), W(588, "Karrablast", 54, 54), W(616, "Shelmet", 57, 57), W(618, "Stunfisk", 55, 56));
        AddWild(result, at["wave"], "Icirrus City", EncounterMethod.Surf,
            W(537, "Seismitoad", 50, 60), W(618, "Stunfisk", 45, 60));
        AddWild(result, at["bolt"], "Lostlorn Forest", EncounterMethod.Cave,
        ...
        AddWild(result, at["toxic"], "Relic Passage", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(183, "Marill", 10, 30), W(184, "Azumarill", 10, 30), W(550, "Basculin", 10, 30));
        AddWild(result, at["legend"], "Reversal Mountain", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(227, "Skarmory", 34, 38), W(322, "Numel", 31, 31), W(323, "Camerupt", 33, 37), W(328, "Trapinch", 32, 34), W(329, "Vibrava", 38, 38), W(426, "Drifblim", 32, 37), W(451, "Skorupi", 31, 37), W(525, "Boldore", 32, 35), W(527, "Woobat", 32, 35), W(530, "Excadrill", 32, 35), W(531, "Audino", 31, 34));
        AddWild(result, at["legend"], "Reversal Mountain", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["legend"], "Reversal Mountain", EncounterMethod.ShakingGrass,
            W(332, "Cacturne", 40, 55));
        ...
        AddWild(result, at["wave"], "Route 3", EncounterMethod.Surf,
            W(341, "Corphish", 45, 60), W(342, "Crawdaunt", 50, 60), W(550, "Basculin", 45, 60));
        AddWild(result, at["wave"], "Route 3", EncounterMethod.ShakingGrass,
            W(314, "Illumise", 40, 55));
        AddWild(result, at["insect"], "Route 4", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(551, "Sandile", 14, 17), W(554, "Darumaka", 14, 17), W(559, "Scraggy", 17, 17), W(572, "Minccino", 14, 17));
        AddWild(result, at["insect"], "Route 4", EncounterMethod.Surf,
            W(592, "Frillish", 5, 15), W(593, "Jellicent", 5, 20), W(594, "Alomomola", 5, 20));
        AddWild(result, at["bolt"], "Route 5", EncounterMethod.Grass,
            W(510, "Liepard", 22, 26), W(531, "Audino", 21, 24), W(568, "Trubbish", 21, 26), W(572, "Minccino", 21, 25), W(573, "Cinccino", 24, 24), W(577, "Solosis", 21, 26), W(587, "Emolga", 22, 22));
        ...
        AddWild(result, at["wave"], "Seaside Cave", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(86, "Seel", 25, 40), W(87, "Dewgong", 30, 40), W(592, "Frillish", 25, 40), W(593, "Jellicent", 25, 40));
        AddWild(result, at["legend"], "Strange House", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(20, "Raticate", 32, 33), W(42, "Golbat", 32, 33), W(354, "Banette", 32, 34), W(577, "Solosis", 31, 31), W(578, "Duosion", 33, 34), W(607, "Litwick", 31, 33));
        AddWild(result, at["legend"], "Strange House", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Striaton City", EncounterMethod.Grass,
            W(0, "---", 0, 0));
        ...
        AddWild(result, at["quake"], "Underground Ruins", EncounterMethod.Surf,
            W(0, "---", 0, 0));
        AddWild(result, at["wave"], "Victory Road (B2/W2)", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(95, "Onix", 41, 50), W(206, "Dunsparce", 49, 49), W(315, "Roselia", 48, 55), W(334, "Altaria", 49, 55), W(354, "Banette", 47, 50), W(407, "Roserade", 50, 50), W(520, "Tranquill", 47, 55), W(521, "Unfezant", 50, 50), W(525, "Boldore", 41, 50), W(530, "Excadrill", 41, 50), W(531, "Audino", 47, 50), W(533, "Gurdurr", 47, 55), W(538, "Throh", 48, 55), W(539, "Sawk", 50, 50), W(548, "Petilil", 47, 55), W(549, "Lilligant", 50, 50), W(621, "Druddigon", 47, 50), W(623, "Golurk", 48, 50), W(634, "Zweilous", 49, 50));
        AddWild(result, at["wave"], "Victory Road (B2/W2)", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(183, "Marill", 35, 50), W(184, "Azumarill", 40, 50), W(418, "Buizel", 35, 50), W(419, "Floatzel", 40, 50), W(550, "Basculin", 35, 50));
        AddWild(result, at["legend"], "Village Bridge", EncounterMethod.Grass,
            W(55, "Golduck", 36, 42), W(183, "Marill", 36, 42), W(184, "Azumarill", 39, 39), W(206, "Dunsparce", 37, 37), W(335, "Zangoose", 37, 43), W(336, "Seviper", 37, 43), W(531, "Audino", 36, 39), W(587, "Emolga", 37, 37));
        AddWild(result, at["legend"], "Village Bridge", EncounterMethod.Surf,
            W(131, "Lapras", 30, 40), W(183, "Marill", 25, 40), W(184, "Azumarill", 30, 40), W(550, "Basculin", 25, 40));
        ...
        AddWild(result, at["basic"], "Virbank City", EncounterMethod.Surf,
            W(592, "Frillish", 5, 15), W(593, "Jellicent", 5, 15), W(594, "Alomomola", 5, 15));
        AddWild(result, at["basic"], "Virbank Complex", EncounterMethod.Grass,
            W(0, "---", 0, 0), W(58, "Growlithe", 11, 14), W(81, "Magnemite", 10, 13), W(109, "Koffing", 10, 14), W(239, "Elekid", 10, 13), W(504, "Patrat", 10, 14), W(519, "Pidove", 10, 13), W(531, "Audino", 10, 13));
        AddWild(result, at["basic"], "Virbank Complex", EncounterMethod.Surf,
            W(0, "---", 0, 0), W(592, "Frillish", 5, 15), W(593, "Jellicent", 5, 15), W(594, "Alomomola", 5, 15));
        AddWild(result, at["wave"], "Wellspring Cave", EncounterMethod.Cave,
            W(0, "---", 0, 0), W(525, "Boldore", 55, 58), W(527, "Woobat", 55, 58), W(530, "Excadrill", 55, 58));
